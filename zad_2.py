...
class Employee:
    ...
    def __str__(self):
        return f"F_NAME: {self.first_name} ; " \
               f"L_NAME: {self.last_name} ; " \
               f"H_DATE: {self.hire_date} ; " \
               f"B_DATE: {self.birth_date} ; PHONE:{self.phone} " \
               f"CITY: {self.city} ; " \
...
class Book:
    ...
    def __str__(self):
        return f"LIBRARY: {self.library} ; " \
               ...
               f"AUTOR_NAME: {self.author_name} ; " \
               f"AUTOR_SURNAME: {self.author_surname} ;" \
               f" NUMER_OF_PAGES:{self.number_of_pages}\n"


# Stworzyć 2 biblioteki (2 instancje klasy), 5 książek,
# 3 pracowników, 3 studentów, oraz 2 zamówienia.
# Wyświetlić oba zamówienia ( print )

lib1 = Library("Katowice", "Zamkowa",
               "41-910", "10", "32-286-34-22")
print(lib1)
lib2 = Library("Bytom", "Do koła",
               "41-910", "12", "32-286-34-22")
print(lib2)

ks1 = Book(lib1, "10.10.2000", "Jan",
           "Kowalski", "100")
print(ks1)
ks2 = Book(lib1, "10.10.2001",
           "Maciej", "Kowalski", "120")
print(ks2)
ks3 = Book(lib2, "10.10.2003",
           "Mikołaj", "Nowak", "80")
print(ks3)
ks4 = Book(lib2, "10.10.2009",
           "Jan", "Adam", "70")
print(ks4)
ks5 = Book(lib1, "10.10.2012",
           "Artur", "Mróz", "140")
print(ks5)

pr1 = Employee("Mikołaj", "Mróz", "10.10.2014", "08.03.1990",
               "Bytom", "Do koła", "41-902", "345-236-129")
pr2 = Employee("Adam", "Nowak", "10.11.2014", "14.05.1992",
               "Bytom", "Kołobrzeska", "41-902", "367-123-127")
pr3 = Employee("Kamil", "Kowalski", "10.12.2014", "10.06.1993",
               "Bytom", "Chorzowska", "41-902", "395-798-800")
print(pr1)
print(pr2)
print(pr3)
